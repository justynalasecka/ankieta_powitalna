...
with st.sidebar:
    ...
    st.markdown("Pomożemy Ci znaleźć osoby, które mają podobne zainteresowania. Zostaniesz przypisany do jednej z 4 grup.")
...
# Utwórzmy obiekt zakładek
tab0, tab1 = st.tabs(["Dane ogólne","Preferencje"])
